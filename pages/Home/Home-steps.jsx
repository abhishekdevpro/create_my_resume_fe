...
const Home_step = () => {
  const steps = [
    { title: 'Open Canva', description: 'Open up Canva and search for "Resume" to start designing your own.' },
  ...
  return (
    <div className="flex flex-col md:flex-row items-start gap-8 bg-gray-50 p-8">
      ...
      <div className="w-full md:w-1/2">
        <h1 className="text-4xl font-bold text-gray-900 mb-8">How to make a resume</h1>
        
        <div className="space-y-4">
          {steps.map((step, index) => (
            <div 
              key={index} 
              className="border-l-4 border-teal-700 bg-white p-4 rounded-lg shadow-sm"
            >
