  ...
  return (
    <div>
      ...
      <div className="m-10  shadow-2xl max-w-4xl mx-auto my-5 p-6 sm:p-10 bg-white rounded-lg">
        ...
        At Create My Resume , we believe that every job seeker deserves a standout
        ...
        Upload your existing resume to the Create My Resume platform. Our AI will start
        ...
        Transform your resume with Create My Resume ’s AI Resume Enhancer. Sign up now
