    ...
    <div>
      ...
      <div className="m-4 sm:mx-10 lg:mx-40 p-4 sm:p-6 shadow-2xl">
        <h1 className="text-3xl sm:text-4xl lg:text-5xl font-semibold my-4 underline">
          Careers at Create My Resume
        </h1>
        <h2 className="text-xl sm:text-2xl font-semibold my-2 mt-5">
          Join Our Team
        </h2>
        <p className="text-base sm:text-lg">
          At Create My Resume, we are committed to helping individuals achieve
          their career goals through expertly crafted resumes and personalized
          career services. Our team is passionate about making a difference in
          the lives of job seekers, and we’re always on the lookout for talented
        ...
        <p className="text-base sm:text-lg">
          At Create My Resume, we believe in the power of collaboration. Our
          team members work closely together, sharing ideas and supporting one
        ...
        <p className="text-base sm:text-lg">
          Your work at Create My Resume will have a direct impact on our
          clients’ lives. By helping job seekers present their best selves to
          potential employers, you’ll play a crucial role in their career
          success. There’s nothing more rewarding than knowing you’ve
          contributed to someone’s journey towards their dream job.
        </p>
        ...
        <p className="text-base sm:text-lg">
          ...
          client has a positive experience with Create My Resume.
        </p>
        ...
        <p className="text-base sm:text-lg">
          At Create My Resume, you’ll have the opportunity to make a meaningful
