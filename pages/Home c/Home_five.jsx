...
//               <i className="fa-solid fa-check border-2 px-2 py-2 rounded-full text-white bg-teal-600"></i>
//               <span>AI Score</span>
//             </div>
//             <div className="flex items-center gap-2 font-medium mb-2">
//               <i className="fa-solid fa-check border-2 px-2 py-2 rounded-full text-white bg-teal-600"></i>
...
//               <button className="px-6 py-3 rounded-2xl font-semibold text-black bg-green-400 hover:bg-teal-600 shadow-md">
