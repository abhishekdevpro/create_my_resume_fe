...
//       <div><i className="fa-solid fa-check border-2 px-3 py-1 rounded-full text-white bg-teal-600 "></i>Chosen & Crafted by Our Experts</div>
//       <div><i className="fa-solid fa-check border-2 px-3 py-1 rounded-full text-white bg-teal-600 "></i>Backed by our Technology</div>
//     </div>

//     <div className=' text-lg text-left flex flex-col gap-4 '>
//       <div><i className="fa-solid fa-check border-2 px-3 py-1 rounded-full text-white bg-teal-600 "></i> Powered by our Robust AI </div>
//        <div><i className="fa-solid fa-check border-2 px-3 py-1 rounded-full text-white bg-teal-600 "></i> Get it ready in less than 15 minutes</div>
//     </div>
//     </div>
//   </div>
...
//                     <h1 className='font-bold text-xl text-center mt-2' id='homecard'>{template.title}</h1>
//                     <Link href="/dashboard/profile">
//                         <button className='absolute top-0 left-0 right-0 bottom-0 m-auto w-fit h-fit bg-teal-600 text-white font-bold py-2 px-4 rounded-full opacity-0 group-hover:opacity-100 transition-opacity duration-300' id='home_third'>
//                             Create Your Resume
//                         </button>
//                     </Link>
//                 </div>
...
//         <h1 className='font-bold  text-xl text-center mt-2' id='homecard'>{template.title}</h1>
//         <Link href="/dashboard/profile">
//         <button className='absolute top-0 left-0 right-0 bottom-0 m-auto w-fit h-fit bg-teal-600 text-white font-bold py-2 px-4 rounded-full opacity-0 group-hover:opacity-100 transition-opacity duration-300' id='home_third'>Create Your CV </button>
//         </Link> </div>
//     ))}
//   </div>
// </div>
