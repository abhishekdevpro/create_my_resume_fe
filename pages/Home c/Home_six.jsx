  ...
  return (
    <div className="py-16 bg-gray-50">
      <div className="mx-auto max-w-screen-lg text-center mb-12">
        <h2 className="mb-6 text-4xl font-extrabold text-teal-700 tracking-tight border p-4 rounded-2xl border-gray-200">
          {t("choose_plan")}
        </h2>
      </div>
      ...
      {/* <div className="text-center mt-8">
        <Link 
          to="/pricing" 
          className="inline-block px-8 py-3 text-lg font-medium text-white bg-teal-700 rounded-xl hover:bg-[#019b73] transition duration-300"
        >
          {t("view_all_plans")}
        </Link>
      </div> */}
