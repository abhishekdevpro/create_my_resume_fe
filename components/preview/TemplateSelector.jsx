  ...
  return (
    <div className="font-sans">
      <div className="flex flex-col md:flex-row gap-2 m-2">
        <button
          onClick={openModal}
          className="hidden md:block rounded-lg border-2 border-teal-500 px-5 py-2 font-bold bg-white text-black"
        >
          <span>
        ...
        <button
          onClick={openModal}
          className="block md:hidden rounded-lg border-2 border-teal-500 px-5 py-2 font-bold bg-white text-black"
        >
                  ...
                  {getDisplayedTemplates().map((template) => (
                    ...
                    >
                      <div
                        ...
                        ${
                          template.key === templateId
                            ? "bg-teal-100 ring-4 ring-teal-500 ring-offset-2"
                            : "hover:bg-gray-50"
                        }
                      `}
                      >
                        <div className="relative">
                          ...
                          />
                          {template.key === templateId && (
                            <div className="absolute inset-0 border-4 border-teal-500 rounded-lg pointer-events-none" />
                          )}
                        </div>
