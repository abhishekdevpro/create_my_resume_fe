  ...
  return (
    <div className="max-w-3xl mx-auto p-5 bg-white-500 shadow-md">
      ...
      <div class="flex gap-1 items-start bg-neutral-200	">
        <div class=" w-1/3 p-5 	">
          <div class="border-solid border-teal-900 mb-5">
            <img
              src={
          ...
          <div class="text-left text-teal-900">
            <div className="mb-8">
              <h2
                className="text-xl text-teal-900 font-bold mb-2"
                style={{ color: headerColor }}
              >
                CONTACT
              </h2>
              <div class="border-solid border-b-2 border-teal-900 mb-2"></div>
              <ContactInfo
          ...
          <div className="mb-8">
            <h2
              className="text-xl text-teal-900 mb-5 font-bold mb-2"
              style={{ color: headerColor }}
            >
              EDUCATION
            </h2>
        ...
        <div class="w-2/3 bg-white">
          <div className="mb-8 pt-2.5	">
            <h1
              className="text-4xl text-center text-teal-900 font-bold mb-4"
              style={{ color: headerColor }}
            >
              {resumeData.name}
            </h1>
            <h2
              className="text-2xl text-white text-center tracking-wide bg-teal-900	 uppercase font-light mb-3"
              style={{ color: headerColor }}
            >
              {resumeData.position}
            </h2>
          ...
          <div className="p-5">
            <h2
              className="text-xl font-bold mb-4 text-teal-900"
              style={{ color: headerColor }}
            >
              ABOUT ME
            </h2>
            <div class="border-solid border-b-2 border-teal-800 mb-5"></div>
            <p
          ...
          <div className="p-5">
            ...
            <div>
              <h3
                className="text-xl text-teal-900 font-semibold border-b-2 border-teal-900 pb-2 mb-4"
                style={{ color: headerColor }}
              >
                Projects
              </h3>
            ...
            <div class=" text-left">
              <h2 class="text-2xl font-bold uppercase text-teal-900 mb-5">
                Reference
              </h2>
              <div class="border-solid border-2 border-teal-900 mb-5"></div>
